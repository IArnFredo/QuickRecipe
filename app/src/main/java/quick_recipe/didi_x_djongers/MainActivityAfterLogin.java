...
public class MainActivityAfterLogin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        docRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    MainAdapter mainAdapter = new MainAdapter(MainActivityAfterLogin.this, List,NamaMakanan,BahanBahan,Langkah_pembuatan,videoUrl,idUser,idMakanan, nameUser);
...
//        nav
        ...
        toggle.syncState();
        navigationView.setNavigationItemSelectedListener(MainActivityAfterLogin.this);
